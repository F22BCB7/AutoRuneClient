...
public class ActionOpcodes {
    public static final int ITEM_ON_OBJECT  = 1; // Using a 'Selected Item' on a SceneObject
    public static final int SPELL_ON_OBJECT = 2; // Using a 'Selected Spell' on a SceneObject
    //-----------------------------------
    ...
    public static final int OBJECT_ACTION_0 = 3;    // ^ Index 0
    public static final int OBJECT_ACTION_1 = 4;    // ^ Index 1
    public static final int OBJECT_ACTION_2 = 5;    // ^ Index 2
    public static final int OBJECT_ACTION_3 = 6;    // ^ Index 3
    public static final int OBJECT_ACTION_4 = 1001; // ^ Index 4
    public static final int EXAMINE_OBJECT  = 1002;
    //-----------------------------------
    public static final int ITEM_ON_NPC  = 7;  // Using a 'Selected Item' on a NPC
    public static final int SPELL_ON_NPC = 8;  // Using a 'Selected Spell' on a NPC
    ...
    public static final int NPC_ACTION_0 = 9;   // ^ Index 0
    public static final int NPC_ACTION_1 = 10;  // ^ Index 1
    public static final int NPC_ACTION_2 = 11;  // ^ Index 2
    public static final int NPC_ACTION_3 = 12;  // ^ Index 3
    public static final int NPC_ACTION_4 = 13;  // ^ Index 4
    public static final int EXAMINE_NPC  = 1003;
    //--------------------------------------
    public static final int ITEM_ON_PLAYER  = 14;  // Using a 'Selected Item' on a Player
    public static final int SPELL_ON_PLAYER = 15;  // Using a 'Selected Spell' on a Player
    ...
    public static final int PLAYER_ACTION_0 = 44; // ^ Index 0
    public static final int PLAYER_ACTION_1 = 45; // ^ Index 1
    public static final int PLAYER_ACTION_2 = 46; // ^ Index 2
    public static final int PLAYER_ACTION_3 = 47; // ^ Index 3
    public static final int PLAYER_ACTION_4 = 48; // ^ Index 4
    public static final int PLAYER_ACTION_5 = 49; // ^ Index 5
    public static final int PLAYER_ACTION_6 = 50; // ^ Index 6
    public static final int PLAYER_ACTION_7 = 51; // ^ Index 7
    //--------------------------------------
    public static final int ITEM_ON_GROUND_ITEM  = 16;
    public static final int SPELL_ON_GROUND_ITEM = 17;
    ...
    public static final int GROUND_ITEM_ACTION_0 = 18;
    public static final int GROUND_ITEM_ACTION_1 = 19;
    public static final int GROUND_ITEM_ACTION_2 = 20;
    public static final int GROUND_ITEM_ACTION_3 = 21;
    public static final int GROUND_ITEM_ACTION_4 = 22;
    public static final int EXAMINE_GROUND_ITEM  = 1004;
    //---------------------------------------------------------------------
    public static final int WALK_HERE = 23;
    //---------------------------------------------------------------------
    // Function-Interfaces in which have some client-side effect when pressed
    public static final int BUTTON_INPUT   = 24; // Type 1
    public static final int BUTTON_SPELL   = 25; // Type 2
    public static final int BUTTON_CLOSE   = 26; // Type 3
    //--------- 27 does not exist
    public static final int BUTTON_VARFLIP = 28; // Type 4
    public static final int BUTTON_VARSET  = 29; // Type 5
    public static final int BUTTON_DIALOG  = 30; // Type 6
    //---------------------------------------------------------------------
    ...
    public static final int ITEM_ON_ITEM  = 31; // 'Selected Item'  -> Item
    public static final int SPELL_ON_ITEM = 32; // 'Selected Spell' -> Item
    ...
    public static final int ITEM_ACTION_0 = 33;
    public static final int ITEM_ACTION_1 = 34;
    public static final int ITEM_ACTION_2 = 35;
    ...
    public static final int TABLE_ACTION_0 = 39;
    public static final int TABLE_ACTION_1 = 40;
    public static final int TABLE_ACTION_2 = 41;
    public static final int TABLE_ACTION_3 = 42;
    public static final int TABLE_ACTION_4 = 43;
    ...
    public static final int WIDGET_ACTION   = 57;
    public static final int SPELL_ON_WIDGET = 58; // 'Selected Spell' -> Widget
    // Note: WIDGET_ACTION_2 is ONLY for actions between indexes [5, 9]
    public static final int WIDGET_ACTION_2 = 1007; //TODO look into this more...
    //-------------------------------------------------------
